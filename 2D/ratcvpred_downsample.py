...
if __name__ == '__main__':
    ...
    print("mse = %g, mean dist = %g, median dist = %g" % (
        mse(preds, targets), mean_distance(preds, targets), median_distance(preds, targets)))
